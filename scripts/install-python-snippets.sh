...
# Installs Python snippets from this repo to Sublime Text 3's User directory
#
...
SNIPPETS_SOURCE="$REPO_DIR/snippets/python"
...
echo -e "${BLUE}Python Snippets Installer${NC}"
echo "================================"
echo ""
...
echo -e "${BLUE}Found $SNIPPET_COUNT Python snippet(s) to install${NC}"
echo ""
...
if [ $? -eq 0 ]; then
    echo ""
    echo -e "${GREEN}✓ Successfully installed $SNIPPET_COUNT Python snippets!${NC}"
    echo ""
    ...
    echo -e "${BLUE}Type 'pyhelp' in any Python file to see the snippet reference.${NC}"
else
